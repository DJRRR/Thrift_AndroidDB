package cn.fudan.androiddb.util;
...
public class Constants {
    ...
    public static final String APK_SRC_SUFFIX = "_src.tar.gz";


    public static final String LIB_REPO = "LIB_REPO";// the combination of jar_repo and dex_repo
