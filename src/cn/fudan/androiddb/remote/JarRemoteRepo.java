...
import static cn.fudan.androiddb.AndroidDBConfig.PROP_KEY_AAR_ROOT_DIR;
import static cn.fudan.androiddb.AndroidDBConfig.PROP_KEY_APKLIB_ROOT_DIR;
import static cn.fudan.androiddb.AndroidDBConfig.PROP_KEY_JAR_ROOT_DIR;
import static cn.fudan.androiddb.util.Constants.AAR_SUFFIX;
import static cn.fudan.androiddb.util.Constants.APKLIB_SUFFIX;
import static cn.fudan.androiddb.util.Constants.JAR_SUFFIX;
...
public class JarRemoteRepo extends RemoteRepo{
    public static final String JAR_ROOT_DIR = AndroidDBConfig.getConfig(PROP_KEY_JAR_ROOT_DIR);
    public static final String AAR_ROOT_DIR = AndroidDBConfig.getConfig(PROP_KEY_AAR_ROOT_DIR);
    public static final String APKLIB_ROOT_DIR = AndroidDBConfig.getConfig(PROP_KEY_APKLIB_ROOT_DIR);
